...
export const styles = {
  ...
  header: { padding: "18px 20px 12px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 },
  headerCenter: { flex: 1, minWidth: 0, textAlign: "center" },
  eyebrow: { fontSize: 12, letterSpacing: 0.4, color: "#6b7268", marginBottom: 2 },
  h1: { fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: 22, margin: 0, color: "#26312B" },
  viewingSelect: { fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: 16, color: "#26312B", border: "1px solid #DEDAC8", borderRadius: 8, padding: "5px 8px", background: "#fff", maxWidth: "100%" },
